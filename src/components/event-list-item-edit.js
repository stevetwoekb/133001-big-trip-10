      ...
      <header class="event__header">
        <div class="event__type-wrapper">
          <label class="event__type  event__type-btn" for="event-type-toggle-1">
            ...
            <img class="event__type-icon" width="17" height="17" src="${event.icon}" alt="Event type icon">
          </label>
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${startDate} ${startDateTime}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">
            To
          </label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${EndDate} ${endDateTime}">
        </div>
      ...
      <section class="event__details">
        ...
        <section class="event__section  event__section--offers">
          ...
          <div class="event__available-offers">
            ${event.offers.map(createOfferMarkup)}
          </div>
        </section>
        ...
        <section class="event__section  event__section--destination">
          ...
          <div class="event__photos-container">
            <div class="event__photos-tape">
              ${event.photos.map(createPhotosMarkup)}
            </div>
          </div>
        </section>
      </section>
...
export default class EventListItemEdit {
  ...
  getTemplate() {
    return createEventListItemTemplate(this._events);
  }
